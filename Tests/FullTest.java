...
public class FullTest {
    public static void main(String[] args) throws Exception {
        ...
        // x*0
        ex = new Mult(new Num(1), new Num(0));
        ...
        ex = new Mult(new Num(0), new Num(1));
        if (!ex.simplify().toString().equals("0.0"))
...
//        }
        ...
        ex = new Div(new Pow(new Var("x"), new Num(2)), new Pow(new Var("x"), new Num(2)));
        ...
        ex = new Mult(new Pow(new Var("x"), new Num(3)), new Pow(new Var("x"), new Num(3)));
        ...
        ex = new Pow(new Num(-2), new Num(5));
